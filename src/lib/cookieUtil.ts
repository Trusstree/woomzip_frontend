...
export const setUserCookie = (value: any, option?: any) =>
  setCookie(userInfoKey, value, { ...option });
export const getUserCookie = () => getCookie(userInfoKey);
export const removeUserCookie = (option?: any) =>
  removeCookie(userInfoKey, { ...option });
