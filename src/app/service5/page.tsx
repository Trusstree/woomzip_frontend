      ...
      <div className={`mt-5`}>
        ...
        <div className="my-5">
          <div className="row mt-5">
            ...
            <SearchBox rows={7} placeholder={"ex) 문 색깔은 파란색이 좋을 것 같고, 면적은 5평 정도 줄이고 싶습니다. 외장재 콘크리트로 느낌을 살리고 싶습니다."} />
          </div>
          <div className="row mt-5">
            <label className="fw-bold fs-3">트러스나 건축사사무소, 시공사에게 궁금한 것이 있다면 자유롭게 물어봐주세요.</label>
            <SearchBox rows={3} placeholder={"ex) 트러스룰 이용하면 좋은 점이 무엇인지 구체적으로 알고 싶어요."} />
          </div>
        </div>
      </div>
