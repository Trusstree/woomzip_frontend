  ...
  return (
    ...
    >
      ...
      >
        ...
        종종 그 행복을 가로막곤 합니다.
        <br />
        '움집'은 바로 그 점에 착안하여, 건축이 주는 번거로움과 스트레스 없이 꿈을 실현할 수 있도록 돕는 서비스입니다.
        ‘움집’은 농촌 생활을 위한 이동식 모듈러 주택을 중개하며, 고객이 보다 손쉽고 빠르게 집을 지을 수 있도록
        지원합니다.
        <br />
        건축 과정에서의 복잡한 절차와 시간 소모를 최소화하고, 꿈꾸던 집을 짓는 행복을 온전히 누릴 수 있게 만드는 것이
        움집의 목표입니다.
        <br />
        <br />
