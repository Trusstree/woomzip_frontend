        ...
        <div className="row" style={{ color: 'white' }}>
          <div className="row" style={{ marginBottom: '50px' }}>
            ...
            <div className="col-md-4 col-12">
              <div style={{ fontWeight: '600', marginBottom: '10px' }}>소셜</div>
              <div id="social">
        ...
        <div className="pt-3 text-white align-items-center">
          <div className="mb-0 text-white d-flex flex-column">
            ...
            <span style={{ fontSize: '14px' }}>
              사업자 등록번호 : 788-87-03092 | 대표 : 양준우 | 개인정보보호책임자 : 박세홍 | 통신판매업 신고번호 :
              2024-서울동작-0730 | 주소 : 06978 서울특별시 동작구 상도로 55길 8, 304호(상도동)
            </span>
          </div>
        </div>
      </div>
