            ...
            <div key={index} className="col-md-6 col-12">
              <div className="card" style={{ width: '100%', border: 'none', marginBottom: '30px' }}>
                ...
                <div style={{ padding: '10px' }}>
                  <div style={{ color: '#777777', fontSize: '17px' }}>{product.company}</div>
                  <div className="d-flex justify-content-between">
                    <div style={{ color: '#222222', fontSize: '22px' }}>{product.productName}</div>
                    <div style={{ color: '#222222', fontSize: '22px' }}>
                      <span style={{ color: '#314FC0', fontSize: '24px' }}>{product.price}</span>
                      {product.currency}
                    </div>
                  </div>
                </div>
