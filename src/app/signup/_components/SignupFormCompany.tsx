  ...
  return (
    <div className="my-5">
      ...
      <SignupTextBox
        ...
        explain={
          "*회사를 표현할 수 있는 한 줄 소개글을 작성해주세요 (업체 프로필에 노출됩니다)"
        }
      />
      ...
      <div className="row">
        ...
        <div className="col-10">
          ...
          />
          <div
            style={{ fontSize: "13px", color: "blue", marginBottom: "10px" }}
          >
      ...
      <div className="row">
        ...
        <div className="col-10">
          ...
          <div
            style={{ fontSize: "13px", color: "blue", marginBottom: "10px" }}
          >
            *최소 7장의 포트폴리오 사진을 업로드 해주세요 (업체 프로필에
            노출됩니다)
          </div>
        </div>
      </div>
      ...
      <SignupTextBox
        ...
        explain={
          "*현재 운영중인 홍보채널(유튜브, 블로그 등) 주소를 입력해주세요"
        }
      />
