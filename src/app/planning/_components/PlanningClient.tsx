  ...
  return (
    <div className="row">
      <div className="col-md-8 col-12">
        ...
        >
          <SelectBox title={'경기도'} value={'경기도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'강원도'} value={'강원도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'충청북도'} value={'충청북도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'충청남도'} value={'충청남도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'경상북도'} value={'경상북도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'경상남도'} value={'경상남도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'전라북도'} value={'전라북도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'전라남도'} value={'전라남도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
          <SelectBox title={'제주도'} value={'제주도'} data={planningInfo.addr} setData={planningInfo.setAddr} />
        </PlanningSelectSection>
