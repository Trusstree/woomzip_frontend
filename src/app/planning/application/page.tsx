...
export default function application() {
  ...
  return <main>
    <div style={{ fontSize: "38px", margin: "120px 0", fontWeight:"600"}}>마지막 단계입니다<br/>준비되셨나요?</div>
    ...
    <div style={{marginBottom:"150px"}}>
        ...
        <SelectBox2 title={"이해관계자 연결"} text={"건축사, 토목사 등을 이어드립니다."} value={"이해관계자 연결"} data={service} setData={setService}/>
    ...
    <div style={{marginBottom:"150px"}}>
        <div style={{ fontSize: "25px", marginBottom: "20px", fontWeight:"600"}}>건축비를 위해 도움이 필요하신가요?</div>
