...
export default function PlanningApplicationClient() {
  ...
  const submit = useCallback(async () => {
    ...
    if (finance.length == 0) {
      alertError(
        "입력이 빠져있어요!",
        "'건축비를 위해 도움이 필요하신가요?' 항목이 선택되지 않았어요!"
      );
      return;
    }
    console.log(planningData);
  ...
  return (
    <>
      <div style={{ marginBottom: "150px" }}>
        <div
          style={{ fontSize: "25px", marginBottom: "20px", fontWeight: "600" }}
        >
          어떤 도움이 필요하신가요?
        </div>
