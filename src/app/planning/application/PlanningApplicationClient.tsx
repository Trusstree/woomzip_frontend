  ...
  return (
    <>
      ...
      <div style={{ marginBottom: "150px" }}>
        ...
        <SelectBox2 title={"최대한 빠르게"} text={"4~10주 내"} value={"ASAP"} data={timeline} setData={setTimeline} />
        <SelectBox2 title={"1년 이내"} text={"12주 내"} value={"Within1Year"} data={timeline} setData={setTimeline} />
        <SelectBox2
          title={"계획 없음"}
          text={"견적만 알아보기"}
          value={"NoPlan"}
