...
import { PriceTextComponent } from "@/components/forms/PriceTextComponent";
          ...
          <div className="d-flex flex-column">
            ...
            <div className="my-2 d-flex flex-column">
              ...
              <div className="d-flex">
                <RadioComponent name={"floor"} title={"1층"} data={1} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"floor"} title={"2층"} data={2} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"floor"} title={"3층 이상"} data={3} onChange={handleText} className={"mx-2"} />
              </div>
            </div>
            ...
            <div className="my-2 d-flex flex-column">
              ...
              <div className="d-flex">
                <RadioComponent name={"room_count"} title={"1개"} data={1} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"room_count"} title={"2개"} data={2} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"room_count"} title={"3개"} data={3} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"room_count"} title={"4개"} data={4} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"room_count"} title={"5개 이상"} data={5} onChange={handleText} className={"mx-2"} />
              </div>
            </div>
            ...
            <div className="my-2 d-flex flex-column">
              ...
              <div className="d-flex">
                <RadioComponent name={"toilet_count"} title={"1개"} data={1} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"toilet_count"} title={"2개"} data={2} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"toilet_count"} title={"3개"} data={3} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"toilet_count"} title={"4개 이상"} data={4} onChange={handleText} className={"mx-2"} />
              </div>
            </div>
            ...
            <div className="my-2 d-flex flex-column">
              ...
              <div className="d-flex">
                <RadioComponent name={"estimate_duration"} title={"1개월"} data={1} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"estimate_duration"} title={"2개월"} data={2} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"estimate_duration"} title={"3개월"} data={3} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"estimate_duration"} title={"4개월"} data={4} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"estimate_duration"} title={"5개월"} data={5} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"estimate_duration"} title={"6개월 이상"} data={6} onChange={handleText} className={"mx-2"} />
              </div>
            </div>
            ...
            <div className="my-2 d-flex flex-column">
              ...
              <div className="d-flex">
                <RadioComponent name={"warranty"} title={"1개월"} data={1} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"warranty"} title={"2개월"} data={2} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"warranty"} title={"3개월"} data={3} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"warranty"} title={"4개월"} data={4} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"warranty"} title={"5개월"} data={5} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"warranty"} title={"6개월 이상"} data={6} onChange={handleText} className={"mx-2"} />
              </div>
            </div>
            ...
            <div className="my-2 d-flex flex-column">
              ...
              <div className="d-flex">
                <RadioComponent name={"hasModel"} title={"yes"} data={"yes"} onChange={handleText} className={"mx-2"} />
                <RadioComponent name={"hasModel"} title={"no"} data={"no"} onChange={handleText} className={"mx-2"} />
              </div>
            </div>
