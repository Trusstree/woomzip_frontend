        ...
        <div className="col-md-4 col-12">
          <div className="row" style={{ marginTop: '15px' }}>
            <div className="col-6" style={{ padding: '10px' }}>
              <div>움집 안심 서비스</div>
              <div style={{ fontSize: '18px', fontWeight: '500' }}>가입</div>
            </div>

            <div className="col-6" style={{ padding: '10px' }}>
              <div>업력</div>
              <div style={{ fontSize: '18px', fontWeight: '500' }}>11.7년</div>
            </div>
            <div className="col-6" style={{ padding: '10px' }}>
              <div>움집 등록기간</div>
              <div style={{ fontSize: '18px', fontWeight: '500' }}>0.7년</div>
            </div>
            <div className="col-6" style={{ padding: '10px' }}>
              <div>등록 제품</div>
              <div style={{ fontSize: '18px', fontWeight: '500' }}>7개</div>
            </div>
          </div>
