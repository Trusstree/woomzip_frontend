...
export default function HouseExpl({ pid, deliveryData, houseData, specificationData, optionData }) {
  ...
  return (
    <>
      {/*상품 네비게이션 */}
      <div className=" sticky-top" style={{ backgroundColor: "white", borderBottom: "1px solid black", zIndex: 1 }}>
      ...
      <div ref={elementB} className="w-full h-screen relative flex flex-col">
        ...
        <div style={{ fontSize: "16px", marginBottom: "40px" }}>{specificationData["specification_description"]}</div>
        <RowText name={"골조 구조"} data={specificationData["framework"]} />
        <hr style={{ border: "1px solid gray" }} />
        <RowText name={"외장재"} data={specificationData["exterior_material"]} />
        <hr style={{ border: "1px solid gray" }} />
        <RowText name={"지붕재"} data={specificationData["insulation_material"]} />
        <hr style={{ border: "1px solid gray" }} />
        <RowText name={"단열재"} data={specificationData["roofing_material"]} />
        <hr style={{ border: "1px solid gray" }} />
        <RowText name={"내장재"} data={specificationData["interior_material"]} />
        <hr style={{ border: "1px solid gray" }} />
      ...
      <div>
        ...
        <div style={{ fontSize: "16px", marginBottom: "40px" }}>
          ...
          <br />
          <span style={{ color: "#314FC0", fontWeight: "600" }}>움집만의 내 집짓기 길잡이, AI 타잔</span>과 내 예상 총
          건축비용을 알아보세요!
          <br />
          <br />
          <span
