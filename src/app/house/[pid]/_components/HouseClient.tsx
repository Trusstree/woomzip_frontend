...
<<<<<<< HEAD:src/app/house/[pid]/_components/HouseClient.tsx
...
>>>>>>> origin/mindul_newnew:src/app/house/[pid]/HouseClient.tsx
      ...
      <BrowserView className="row">
        <div style={{width:"60%", marginTop:"20px", minWidth:"400px"}}>
          <div className="row">
            ...
            <div className="container" style={{width:"12%"}}>
              <div style={{width:"80px", height:"80px", marginBottom:"10px", overflow:"hidden"}}>
                {<img key={0} alt={`external_images_0`} src={imageData["external_images"][0]} width={80} height={80} style={{objectFit:"cover"}}/>}
              </div>
              <div style={{width:"80px", height:"80px", marginBottom:"10px", overflow:"hidden"}}>
                {<img key={1} alt={`external_images_1`} src={imageData["external_images"][1]} width={80} height={80} style={{objectFit:"cover"}}/>}
              </div>
              <div style={{width:"80px", height:"80px", marginBottom:"10px", overflow:"hidden"}}>
                {<img key={0} alt={`internal_images_0`} src={imageData["internal_images"][0]} width={80} height={80} style={{objectFit:"cover"}}/>}
              </div>
              <div style={{width:"80px", height:"80px", marginBottom:"10px", overflow:"hidden"}}>
                {<img key={1} alt={`internal_images_1`} src={imageData["internal_images"][1]} width={80} height={80} style={{objectFit:"cover"}}/>}
              </div>
              <div style={{width:"80px", height:"80px", marginBottom:"10px", overflow:"hidden"}}>
                {<img key={1} alt={`internal_images_2`} src={imageData["internal_images"][1]} width={80} height={80} style={{objectFit:"cover"}}/>}
              </div>
              <div style={{width:"80px", height:"80px", marginBottom:"10px", overflow:"hidden"}}>
                {<img key={0} alt={`floor_plan_images_0`} src={imageData["floor_plan_images"][0]} width={80} height={80} style={{objectFit:"cover"}}/>}
              </div>
            </div>
          </div>
          ...
          <div ref={elementA}
            ...
            <h5 style={{margin:"100px 0 30px 0"}}>
              기본 정보
            </h5>
            ...
            <div className="row">
              ...
              <div className="col-8" style={{fontSize:"16px"}}>
                {houseData["estimate_duration"]}개월
              </div>
            </div>
            <hr style={{border:"1px solid gray"}}/>
            <div className="row">
          ...
          <div ref={elementB}
            className="w-full h-screen relative flex flex-col">
            <h5 style={{margin:"150px 0 30px 0"}}>
              상세 정보
            </h5>
            <div style={{fontSize:"16px", marginBottom:"40px"}}>
          ...
          <div>
            ...
            <div style={{fontSize:"16px", marginBottom:"40px"}}>
              ...
              <br/>
              <br/>
              토지 위치와 진입 환경에 따라 <span style={{color:"#314FC0", fontWeight:"600"}}>배송비가 최대 2.5배 추가될 수 있어요!</span>
              <br/>
          ...
          <div>
            ...
            <div style={{fontSize:"16px", marginBottom:"40px"}}>
              <span style={{color:"#314FC0", fontWeight:"600"}}>움집</span>의 모든 제품과 옵션에는 원칙적으로 제작 도중 추가비용이 발생하지 않으니, 안심하세요!
              <br/><span style={{fontSize:"14px"}}>(단, 소비자의 변경 요청사항에 따른 추가 비용 발생 제외)</span>
              <br/>
              <br/>
              고지된 비용에 제품 제작을 제외한 부대 비용은 포함되어 있지 않아요.
              <br/>
              인허가, 토목공사, 기초공사, 각종 인입 공사, 보험, 세금 등 지금 보고 있는 비용에서 <span style={{color:"#314FC0", fontWeight:"600"}}>평균 약 30%정도가 추가되고 있어요!</span>
              <br/>
            ...
            <div className="row">
              ...
              <div className="col-8" style={{fontSize:"16px"}}>
                {detailPriceText(houseData["final_price"]/10)}
              </div>
            </div>
            <hr style={{border:"1px solid gray"}}/>
            <div className="col-4" style={{fontSize:"16px", fontWeight:"600", margin:"40px 0 20px 0"}}>
              옵션 가격
            </div>
            {optionData &&
                optionData.map((e, i) => (
        ...
        <div className="container" style={{width:"40%", marginTop:"20px", minWidth:"400px"}}>
          <div className="sticky-top">
            ...
            style={{width:"90%", marginLeft:"10%", border:"none"}}>
              ...
              <div className={"text-decoration-line-through mx-1"} style={{ color: "gray", textDecoration: "" }}>
                  {houseData["price"]}
              </div>
                {houseData["discount_rate"] > 0 && ( //houseData.discount
                  <>
                    <span style={{ color: "#314FC0", marginRight:"20px", fontSize:"24px" }}>
              ...
              <div className="d-flex" style={{marginLeft:"10%", marginTop:"15px", width:"90%"}}>
                <div>
              ...
              <div className="row" style={{width:"90%", marginLeft:"10%"}}>
                <div className="row" style={{width:"125px"}}>
                  ...
                  <div style={{width:"72px", fontSize:"16px", marginTop:"3px"}}>
                    {houseData["total_floor_area"]?.toFixed(1) || "NaN"}평
                  </div>
                </div>
                
                <div className="row" style={{width:"115px"}}>
                  <div style={{width:"28px", padding:"0"}}>
                    <svg
                      width="30"
                      height="30"
                ...
                <div className="row" style={{width:"157px"}}>
                  <div style={{width:"29px", color:"gray", marginTop:"3px"}}>
                    AS
                  </div>
                  <div style={{width:"100px", fontSize:"16px", marginTop:"3px"}}>
                    {houseData["warranty"]}
                  </div>
                </div>
              </div>
              
              <div className={""} style={{width:"90%", marginLeft:"10%"}}>
                <select
                  onChange={(ee) => {
                  ...
                  {selectedOptionData &&
                    selectedOptionData.map((e, i) => (
                      <div key={i} className="d-flex align-items-center justify-content-between">
                        <div className="row d-flex align-items-center" style={{width:"auto"}}>
                          <div
                            className="btn"
              ...
              <div className="d-flex justify-content-between" style={{marginLeft:"10%", marginTop:"20px"}}>
                <div style={{width:"100px", fontSize:"16px"}}>
                  총 금액
                </div>
                <div style={{width:"auto", fontSize:"20px", fontWeight:"500"}}>
                  {houseData["final_price"]}원
                </div>
              </div>

              <div className={"row"} style={{marginTop:"15px", marginLeft:"10%"}}>
                <div style={{width:"48%", margin:"0", padding:"0"}}>
                  <div
                    className="w-100 btn text-white py-3 d-flex justify-content-center align-items-center"
                    onClick={() => {
                ...
                <div style={{width:"48%", marginLeft:"2%", padding:"0"}}>
                  <div
                    className="w-100 btn text-white py-3 d-flex justify-content-center align-items-center"
                    style={{ backgroundColor: "#314FC0", height:"60px" }}
                    onClick={() => {
        ...
        <MobileView style={{ width: "95vw", marginLeft: "-12vw", overflow: "hidden" }}>
          <div style={{marginTop:"15px", width:"96%", marginLeft:"2%"}}>
            <Image
          ...
          <div
            className="card"
            style={{width:"95%", border:"none", marginLeft:"5%"}}>
              <div style={{fontSize:"15px", marginTop:"10px"}} onClick={() => {}}>
                  {houseData["seller_nickname"]}
              </div>
              <div style={{fontSize:"20px", fontWeight:"600", margin:"5px 0"}}>
                {houseData["house_name"]}
              </div>
              <div className={"text-decoration-line-through mx-1"} style={{ color: "gray", textDecoration: "" }}>
                  {houseData["price"]}
              ...
              <div>
                {houseData["discount_rate"] > 0 && ( //houseData.discount
                  <>
                    <span style={{ color: "#314FC0", marginRight:"10px", fontSize:"20px" }}>
                      {houseData["discount_rate"]}%
                    </span>
                  </>
                )}
              ...
              <div className="d-flex" style={{marginTop:"8px", marginLeft:"4%", width:"95%"}}>
                <div>
                  {houseData["has_model"] == "1" && (
                    <div className="badge text-white p-2 mx-1" style={{ backgroundColor: "#136E11"}}>
                      모델하우스
                ...
                <div style={{marginTop:"3px"}}>{heart}</div>
              </div>
              
              <hr style={{width:"90%", marginLeft:"5%"}}/>
              <div className="row" style={{width:"95%", marginLeft:"5%"}}>
                <div className="row" style={{width:"auto"}}>
                  <div style={{width:"25px", padding:"0"}}>
                    <svg
                      width="30"
                      height="30"
                      viewBox="0 0 30 30"
                  ...
                  <div style={{width:"auto", fontSize:"15px", marginTop:"4px"}}>
                    {houseData["total_floor_area"]?.toFixed(1) || "NaN"}평
                  </div>
                </div>
              ...
              <div className="d-flex justify-content-between" style={{marginLeft:"5%", marginTop:"15px", width:"90%"}}>
                <div style={{width:"100px", fontSize:"15px"}}>
                  총 금액
                </div>
                <div style={{width:"auto", fontSize:"18px", fontWeight:"500"}}>
                  {houseData["final_price"]}원
                </div>
              </div>

              <div className={"row"} style={{marginTop:"10px", marginLeft:"5%", width:"90%"}}>
                <div style={{width:"49%", margin:"0", padding:"0"}}>
                  <div
                    className="btn text-white py-3 d-flex justify-content-center align-items-center"
                    onClick={() => {
                      router.push(modelLink);
                    }}
                    style={{ backgroundColor: "#314FC0", height:"55px" }}
                  >
                ...
                <div style={{width:"49%", marginLeft:"2%", padding:"0"}}>
                  <div
                    className="w-100 btn text-white py-3 d-flex justify-content-center align-items-center"
                    style={{ backgroundColor: "#314FC0", height:"55px" }}
                    onClick={() => {
          ...
          <div ref={elementC}
            className="w-full h-screen relative flex flex-col" style={{marginTop:"150px"}}>
            <ReviewInfo />
          </div>
