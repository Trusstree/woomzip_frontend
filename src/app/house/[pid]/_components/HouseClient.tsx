    ...
    <>
      <main>
        <BrowserView className="row">
          <div style={{ width: "60%", marginTop: "20px", minWidth: "400px" }}>
                ...
                <div style={{ width: "80px", height: "80px", marginBottom: "10px", overflow: "hidden" }}>
                  {
                    <img
                      ...
                      src={imageData["floor_plan_images"][0]}
                      width={80}
                      height={80}
                      style={{ objectFit: "cover" }}
                    />
            ...
            <div
              ...
              style={{ margin: "45px 0", backgroundColor: "white", borderBottom: "1px solid black" }}
            >
            ...
            <div>
              ...
              <div style={{ fontSize: "16px", marginBottom: "40px" }}>
                ...
                <br />
                <span style={{ color: "#314FC0", fontWeight: "600" }}>움집만의 내 집짓기 길잡이, AI 타잔</span>과 내
                예상 배송비용을 꼭 확인해보세요!
                <br />
                <br />
                <span
            ...
            <div>
              ...
              <div style={{ fontSize: "16px", marginBottom: "40px" }}>
                <span style={{ color: "#314FC0", fontWeight: "600" }}>움집</span>의 모든 제품과 옵션에는 원칙적으로 제작
                도중 추가비용이 발생하지 않으니, 안심하세요!
                <br />
            ...
            <div ref={elementC} className="w-full h-screen relative flex flex-col">
              <h5 style={{ margin: "150px 0 30px 0" }}>판매자 후기(2)</h5>
              <ReviewInfo />
            </div>
          ...
          <div className="container" style={{ width: "40%", marginTop: "20px", minWidth: "400px" }}>
            <div className="sticky-top">
              <div className="card" style={{ width: "90%", marginLeft: "10%", border: "none" }}>
                ...
                <span style={{ fontSize: "24px", fontWeight: "500" }}>{detailPriceText(houseData["final_price"])}</span>
              </div>
              ...
              <div className="row" style={{ width: "90%", marginLeft: "10%" }}>
                ...
                <div className="row" style={{ width: "157px" }}>
                  <div style={{ width: "29px", color: "gray", marginTop: "3px" }}>AS</div>
                  <div style={{ width: "100px", fontSize: "16px", marginTop: "3px" }}>{houseData["warranty"]}</div>
                </div>
              </div>
                ...
                <select
                  onChange={(ee) => {
                    if (
                      ...
                      !selectedOptionData.includes(optionData[Number(ee.target.value)])
                    ) {
              ...
              <div className="d-flex justify-content-between" style={{ marginLeft: "10%", marginTop: "20px" }}>
                ...
                <div style={{ width: "auto", fontSize: "20px", fontWeight: "500" }}>{houseData["final_price"]}원</div>
              </div>
        ...
        <MobileView style={{ width: "95vw", marginLeft: "-12vw", overflow: "hidden" }}>
          ...
          <div className="card" style={{ width: "95%", border: "none", marginLeft: "5%" }}>
            <div style={{ fontSize: "15px", marginTop: "10px" }} onClick={() => {}}>
              {houseData["seller_nickname"]}
            </div>
            <div style={{ fontSize: "20px", fontWeight: "600", margin: "5px 0" }}>{houseData["house_name"]}</div>
            <div className={"text-decoration-line-through mx-1"} style={{ color: "gray", textDecoration: "" }}>
              {houseData["price"]}
            </div>
            <div>
              ...
              <span style={{ fontSize: "20px", fontWeight: "500" }}>{detailPriceText(houseData["final_price"])}</span>
            </div>
          </div>
          ...
          <div className="row" style={{ width: "95%", marginLeft: "5%" }}>
            ...
            <div className="row" style={{ width: "auto" }}>
              ...
              <div style={{ width: "auto", fontSize: "15px", marginTop: "4px" }}>{houseData["room_count"]}개</div>
            </div>
            ...
            <div className="row" style={{ width: "auto" }}>
              ...
              <div style={{ width: "auto", fontSize: "15px", marginTop: "4px" }}>{houseData["toilet_count"]}개</div>
            </div>

            <div className="row" style={{ width: "auto" }}>
              <div style={{ width: "29px", color: "gray", marginTop: "3px" }}>AS</div>
              <div style={{ width: "auto", fontSize: "15px", marginTop: "4px" }}>{houseData["warranty"]}</div>
            </div>
          </div>
          ...
          <div className="d-flex justify-content-between" style={{ marginLeft: "5%", marginTop: "15px", width: "90%" }}>
            <div style={{ width: "100px", fontSize: "15px" }}>총 금액</div>
            <div style={{ width: "auto", fontSize: "18px", fontWeight: "500" }}>{houseData["final_price"]}원</div>
          </div>
          ...
          <div>
            ...
            <div style={{ fontSize: "16px", marginBottom: "40px" }}>
              ...
              <span style={{ color: "#314FC0", fontWeight: "600" }}>배송비가 최대 2.5배 추가될 수 있어요!</span>
              <br />
              <span style={{ color: "#314FC0", fontWeight: "600" }}>움집만의 내 집짓기 길잡이, AI 타잔</span>과 내 예상
              배송비용을 꼭 확인해보세요!
              <br />
              <br />
              <span
