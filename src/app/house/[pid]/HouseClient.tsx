        ...
        <div className="row" style={{ width: "90%", maxWidth: "1300px", margin: "0 auto" }}>
          ...
          <div className="row g-2" style={{ width: "100%", position: "relative" }}>
            <div className="col-6">
              <div style={{ borderRadius: "10px 0 0 10px", overflow: "hidden" }}>
                <img src={imageData["representative_images"][0]} style={{ width: "100%", height: "400px", objectFit: "cover" }} />
              </div>
            </div>
            <div className="col-3">
              <div style={{ height: "50%", overflow: "hidden" }}>
                <img src={imageData["external_images"][0]} style={{ width: "100%", height: "196px", objectFit: "cover" }} />
              </div>
              <div style={{ height: "50%", marginTop: "4px", overflow: "hidden" }}>
                <img src={imageData["external_images"][1]} style={{ width: "100%", height: "196px", objectFit: "cover" }} />
              </div>
            </div>
            <div className="col-3">
              <div style={{ height: "50%", overflow: "hidden", borderRadius: "0 10px 0 0" }}>
                <img src={imageData["internal_images"][0]} style={{ width: "100%", height: "196px", objectFit: "cover" }} />
              </div>
              <div style={{ height: "50%", marginTop: "4px", overflow: "hidden", borderRadius: "0 0 10px 0" }}>
                <img src={imageData["internal_images"][1]} style={{ width: "100%", height: "196px", objectFit: "cover" }} />
              </div>
            </div>
          ...
          <div className="col-8">
            ...
            <div
              ...
              style={{ backgroundColor: "white", borderBottom: "1px solid black", zIndex:1 }}
            >
            ...
            style={{width:"90%", border:"none", zIndex:1, marginLeft:"10%"}}>
              ...
              <div style={{padding:"10px", boxShadow: "3px 3px 13px rgba(0, 0, 0, 0.2)", borderRadius:"10px"}}>
                ...
                <div className="d-flex justify-content-between" style={{ width:"99%", marginLeft:"3px", marginTop:"3px"}}>
                  ...
                  <div style={{ width: "auto", fontSize: "16px", fontWeight: "500" }}>{detailPriceText(selectedOptionData.reduce((acc, cur) => (acc+cur["option_product_price"]),0)+houseData["final_price"])}</div>
                </div>
