...
import FillteringCheck from '@/app/house/_components/FillteringCheck';
...
export function SearchModal() {
  ...
  return (
    ...
    >
      <div className="modal-dialog modal-dialog-scrollable" style={{ width: '97%', maxWidth: '750px' }}>
        <div className="modal-content" style={{ width: '100%' }}>
          ...
          <div className="modal-body" style={{ padding: '30px' }}>
            <div style={{ width: '100%', marginBottom: '20px' }}>
              <div style={{ margin: '20px 10px', fontSize: '20px' }}>가격 범위</div>
            ...
            <div style={{ width: '100%', margin: '20px 0' }}>
              <div style={{ margin: '20px 10px', fontSize: '20px' }}>평수 범위</div>
              <div style={{ width: '90%', margin: '0 auto' }}>
                <MultiRangeSlider
            ...
            <div style={{ width: '100%', margin: '20px 0' }}>
              <div style={{ margin: '20px 10px', fontSize: '20px' }}>침실 및 욕실</div>
              <div style={{ margin: '20px 0' }}>
                <div style={{ margin: '0 10px', fontSize: '16px' }}>층</div>
                <div className="row g-2">
                  <FillteringButton title={'상관 없음'} name={'floor_count'} type={'select'} />
                  <FillteringButton title={'1'} value={1} name={'floor_count'} type={'select'} />
                  <FillteringButton title={'2'} value={2} name={'floor_count'} type={'select'} />
                </div>
              </div>
              <div style={{ margin: '20px 0' }}>
            ...
            <div style={{ width: '100%', margin: '20px 0' }}>
              ...
              <div style={{ margin: '20px 0' }}>
                <div style={{ margin: '0 10px', fontSize: '16px' }}>AS 보증기간</div>
                <div className="row g-2">
                  <FillteringButton title={'상관 없음'} name={'warranty'} type={'text'} />
              ...
              <div style={{ margin: '20px 0' }}>
                <div style={{ margin: '0 10px', fontSize: '16px' }}>제작 소요기간</div>
                <div className="row g-2">
                  <FillteringButton title={'상관 없음'} name={'estimate_duration'} type={'text'} />
            ...
            <div style={{ width: '100%', margin: '20px 0' }}>
              <div style={{ margin: '0 10px', fontSize: '20px' }}>포함 사항</div>
              <div style={{ margin: '20px 0' }}>
                <div style={{ margin: '0 10px', fontSize: '16px' }}>추가사항</div>
                <div className="row" style={{ padding: '20px' }}>
                  <FillteringCheck title={'데크'} value={'데크'} name={'specificity'} type={'select'} />
                  <FillteringCheck title={'다락방'} value={'다락방'} name={'specificity'} type={'select'} />
                  <FillteringCheck title={'발코니'} value={'발코니'} name={'specificity'} type={'select'} />
                  <FillteringCheck title={'베란다'} value={'베란다'} name={'specificity'} type={'select'} />
                  <FillteringCheck title={'옥상'} value={'옥상'} name={'specificity'} type={'select'} />
                </div>
              </div>
            </div>
            <div style={{ margin: '20px 0' }}>
              ...
              <div className="row" style={{ padding: '20px' }}>
                <FillteringCheck title={'경량목'} value={'경량목'} name={'frame'} type={'select'} />
                <FillteringCheck title={'경량스틸'} value={'경량스틸'} name={'frame'} type={'select'} />
                <FillteringCheck title={'기타'} value={'기타'} type={'select'} name={'frame'} />
              </div>
            </div>
          </div>
