      ...
      <div className="container row" style={{ width: "100%" }}>
        <div className="container" style={{ width: "65%", minWidth: "400px", padding: "0", margin: "0" }}>
          ...
          <div style={{ fontWeight: "600", lineHeight: "30px" }}>
            <div style={{ marginTop: "80px", fontSize: "25px" }}>체험 조건</div>
            <div style={{ fontSize: "16px", fontWeight: "400", marginTop: "30px", padding: "10px" }}>
              ✅ 체험 후기 작성
              <br />✅ SNS에 체험 후기 작성(유튜브, 블로그, 카페 등)
            </div>

            <div style={{ marginTop: "80px", fontSize: "25px" }}>보증금 반환 조건</div>
            ...
            <div className="container" style={{ width: "100%", marginBottom: "10px", padding: "0" }}>
              <div style={{ margin: "0", fontSize: "25px", paddingTop: "50px" }}>힐링리버 소개</div>
              <div style={{ fontSize: "16px", fontWeight: "400", marginTop: "30px", padding: "10px" }}>
              ...
              <div style={{ margin: "0", fontSize: "25px", paddingTop: "50px" }}>편의시설</div>
              <div style={{ fontSize: "16px", fontWeight: "400", marginTop: "30px", padding: "10px" }}>
                ● TV
                <br />● 침대
                <br />● 침구
              ...
              <div style={{ margin: "0", fontSize: "25px", paddingTop: "50px" }}>주의사항</div>
              <div style={{ fontSize: "16px", fontWeight: "400", marginTop: "30px", padding: "10px" }}>
