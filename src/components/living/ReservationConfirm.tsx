...
export function ReservationConfirm({
  ...
  return (
    ...
    >
      ...
      <div className="row">
        <button type="button" className="btn btn-success" style={{ width: "150px", marginLeft: "10px" }}>
          수락하기
        </button>
        <button type="button" className="btn btn-danger" style={{ width: "150px", marginLeft: "10px" }}>
          거절하기{" "}
        </button>
      </div>
    </div>
