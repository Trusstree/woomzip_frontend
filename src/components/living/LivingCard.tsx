    ...
    <>
      <div className="card" style={{ border: "none", width: "100%", marginBottom: "15px" }}>
        ...
        >
          ...
          <SwiperSlide>
            <img src="https://trussbucketdev.s3.ap-northeast-2.amazonaws.com/test_house/healingRiver2.jpeg"
              style={{ objectFit: "cover", width: "100%", height: "100%", borderRadius: "10px" }}></img>
          </SwiperSlide>
        </Swiper>

        <div className="card-body" style={{ color: "gray", padding:"5px", overflow:"hidden"}}>
          <div style={{ fontSize: "16px", marginTop:"3px"}}>{company}</div>
          <div className="card-title text-nowrap" style={{ overflow: "hidden", textOverflow: "ellipsis", marginTop: "3px", fontSize: "16px", fontWeight:"600", color:"black"}}>{title}</div>
          <div className="row" style={{ width: "100%", marginTop: "10px" }}>
            ...
            <div className="row" style={{width:"55%"}}>
              <Image
                ...
                style={{ width: "40px" }}
                alt={"gpsIcon"} />
              <div style={{ textAlign: "center", width: "auto", fontSize: "15px", color:"black", padding:"0"}}>{addr}</div>
            </div>
          </div>
          {/* <div style={{width:"150%", marginTop:"5px"}}>
            {badgeExample}
          </div> */}
          <div style={{ fontWeight: "500", fontSize: "15px", color:"#314FC0", marginTop:"5px"}}>
            {context}
          </div>
        </div>
      </div>
