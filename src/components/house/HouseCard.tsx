  ...
  return (
    <div className="col-md-4 col-lg-3">
      <div className="card d-flex flex-column align-items-center w-100">
        ...
        />
        <div className="card-body w-100 pt-1 px-2 fs-6" style={{ height: "230px", backgroundColor: "lightgray" }}>
          ...
          <div className="d-flex flex-column fw-normal">
            <div className="d-flex justify-content-between">
              ...
              <div className="ms-auto">
                {data["discount_rate"] > 0 && (
                  <div
                    className="text-muted text-end text-decoration-line-through m-0 p-0"
                    style={{ fontSize: "14px", height: "14px" }}
                  >
                    {cardPriceText(data["base_price"])}
                  </div>
                )}
