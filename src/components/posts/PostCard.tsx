...
export default function PostCard(props: PostCardProps) {
  ...
  return (
    ...
    <BrowserView className={`${className ? className : ""}`}
      style={{ width: "48%", margin: "10px", minWidth: "400px" }}>

      <div className="card" style={{ backgroundColor: "#FAFBFC", border: "none", height:"230px"}}>
        <div className="card-body" style={{ width: "94%", marginLeft: "3%" }}>
          <div
            style={{
          ...
          <Link
            ...
            style={{ textDecoration: "none", display: "block", fontSize: "22px", fontWeight: "700", margin: "15px 0" }}
          >
            {data.title}
          </Link>
