  ...
  return (
    <>
      <BrowserView className={`${className ? className : ""}`}>
        <div className="card" style={{ width: "100%", border: "none", marginBottom: "15px" }}>
          <Link href={{ pathname: `/community/${data["post_id"]}` }}>
            <img
              src={
                imgSrcArr[0] || "https://trussbucketdev.s3.ap-northeast-2.amazonaws.com/test_house/healingRiver2.jpeg"
              }
              width={"100%"}
              height={280}
