...
export default function PostCard(props: PostCardProps) {
  ...
  return (
    <>
      <BrowserView className={`${className ? className : ""}`}>
        <div className="card" style={{ width: "100%", border: "none", marginBottom: "20px" }}>
          <Link href={{ pathname: `/community/${data["post_id"]}` }}>
            ...
            <div
              className="card-body"
              style={{ width: "100%", height: "280px", borderRadius: "10px", position: "absolute", top: 0, left: 0 }}
            >
              <div
                style={{
      ...
      <MobileView>
        <div className={`${className ? className : ""} col-md-4 col-lg-3`} style={{ width: "100%" }}>
              ...
              <div className={`card-footer`} style={{ border: "none", backgroundColor: "white" }}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div style={{ fontSize: "14px", color: "gray" }}>
                    {data["nickname"]} | {data["created_at"].split("T")[0]}
                  </div>
                </div>
              </div>
            </div>
