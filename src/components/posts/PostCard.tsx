...
export default function PostCard (props: PostCardProps) {
  ...
  return (
    <div className={`${className?className:""} col-md-4 col-lg-3`} style={{width:"48%", margin:"10px", minWidth:"400px"}}>
      <div className="card" style={{backgroundColor:"#FAFBFC", border:"none"}}>
        <div className="card-body" style={{width:"94%", marginLeft:"3%"}}>
          <div 
            style={{backgroundColor:style[data.category].backgroundColor,
          ...
          <Link
            className="text-wrap"
            href={{ pathname: `/community/${data["post_id"]}`,}}
            style={{textDecoration:"none", display: "block", height:"70px", overflow:"hidden", fontSize:"16px", color:"gray", fontWeight:"400", marginBottom:"10px"}}
            ...
            <div className="d-flex justify-content-between">
              <div className="row" style={{width:"auto"}}>
                <div className="d-flex" style={{width:"60px", padding:"0"}}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="gray" width={25}>
