...
export default function MyHouseCard(props: MainPagePostProps) {
  ...
  return (
              ...
              <div className="row d-flex justify-content-between">
                ...
                <div style={{ width: "auto" }}>
                  {data["discount_rate"] > 0 && (
                    <div style={{ color: "#314FC0", fontSize: "16px", fontWeight: "bold" }}>{data["discount_rate"]}%</div>
                  )}
                </div>
              </div>
      ...
      <MobileView className="card"  style={{padding:"5vw", border:"none"}}>
        <div className="row" style={{width:"100%"}} onClick={() => {router.push(`/house/${data["house_id"]}`);}}>
          <div style={{width:"45%"}}>
            <Image
              src={data["house_img_url"] || "/blur_image.png"}
              alt={`${data["house_explanation"]}`}
              width={220}
              height={220}
              style={{ objectFit: "cover", width: "36vw", height: "35vw", borderRadius:"10px"}}
              placeholder={"blur"}
              blurDataURL={"/blur_image.png"}
            />
          </div>
          <div className="card-body" style={{ width:"50vw", border: "none", padding:"0" }}>
            <div className="d-flex flex-column fw-normal" style={{ width: "100%" }}>
              <div style={{ fontSize: "12px", fontWeight: "semiBold", color: "gray", margin: "3px 0" }}>
                {data["company_name"]}
              </div>
